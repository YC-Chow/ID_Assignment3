// referenced from https://github.com/mchlltt/Guess-That-Pokemon
$(document).ready(function () {
  ...
  let DOMFunctions = {
    ...
    ShowQuestion: function () {
      ...
      $(".pokeImg").attr(
        "src",
        currentQuestion.artwork[currentQuestion.answerIndex]
      );
    ...
    ShowAnswer: function (correct) {
      ...
      $(".result").show();
      $("#correct-answer").text(
        "It's " + currentQuestion.answers[currentQuestion.answerIndex] + "!"
      );
      $(".pokeImg").toggleClass("silhouette");
      $(".pokeImg").attr(
        "alt",
        "An image of " + currentQuestion.answers[currentQuestion.answerIndex]
      );
      if (correct === true) {
      ...
      $("#wiki-link").attr(
        ...
        "https://bulbapedia.bulbagarden.net/wiki/" +
          currentQuestion.answers[currentQuestion.answerIndex] +
          "_(Pok%C3%A9mon)"
      );
